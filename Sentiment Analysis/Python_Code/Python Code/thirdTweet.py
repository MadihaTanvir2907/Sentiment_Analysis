...
# list = []
# date_tweets = tweepy.Cursor(api.search_tweets, q='"Russia" "Europe"' , lang = 'en', tweet_mode='extended').items(1000)
...
# Read Data
# df = pd.read_csv('Russia_Europe.csv')
# df.head()
...
# df.to_csv('refined_tweets_Russia.csv')

# Read data from refined data for TfidfVectorizer

df = pd.read_csv('refined_tweets_Russia.csv')
df.head()
...
new_text = [new_text]
print(new_text)
vector = Vectorizer.fit_transform(new_text)
...
df.to_csv('all_keyword _Russia.csv')