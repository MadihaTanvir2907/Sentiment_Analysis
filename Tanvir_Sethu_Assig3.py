...
# # Read Data
df = pd.read_csv('Russsia_Europe.csv')
df.head()
...
df.to_csv('Russia_refined_tweets.csv')

# Read data from refined data for TfidfVectorizer

df = pd.read_csv('Russia_refined_tweets.csv')
df.head()
# *******************************************************************************
...
df.to_csv('all_keyword_Russia.csv')
